...
export function PatientRegister({ onNavigate }: PatientRegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/insert_patient", {
        name: formData.name,
  ...
  if (registered) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-gradient-to-br from-amber-600 via-amber-800 to-gray-900">
        <motion.div
  ...
  // ✅ Registration form
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden bg-gradient-to-br from-amber-600 via-amber-800 to-gray-900">
