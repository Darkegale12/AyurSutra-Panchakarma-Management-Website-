...
import { ArrowLeft, Leaf, Shield, CheckCircle, AlertTriangle, Target } from 'lucide-react';
import { motion } from 'motion/react';
import { useTheme } from '../ThemeProvider';

interface BastiPageProps {
  onNavigate: (page: 'landing') => void;
}

export function BastiPage({ onNavigate }: BastiPageProps) {
    ...
    <div className="min-h-screen text-white dark:text-white text-gray-900 py-8 px-4" style={{
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300">Medicated Enema Therapy</p>
        </motion.div>
          ...
          <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-green-500/20">
            ...
            <CardContent>
              <p className="text-gray-300 leading-relaxed">
                Basti is considered the most powerful Panchakarma therapy, primarily balancing Vata dosha by introducing medicated oils/decoctions into the colon.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-green-500/20">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Preparation</h4>
                  <p className="text-gray-300">Oil massage & steam to loosen toxins.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center text-white font-semibold text-sm mt-1">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Procedure</h4>
                  <p className="text-gray-300">Medicated oil or decoction is introduced rectally.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center text-white font-semibold text-sm mt-1">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Variants</h4>
                  <p className="text-gray-300">Anuvasana Basti (oil-based), Niruha Basti (decoction-based).</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Relieves constipation, bloating, joint pain.</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Improves fertility and sexual health.</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Enhances immunity and strength.</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-green-500/20 h-full">
              ...
              <CardContent>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Arthritis, sciatica, back pain.</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Neurological disorders, infertility.</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start space-x-2">
                  ...
                  <span>Should not be self-administered.</span>
                </li>
                <li className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Avoid in diarrhea, rectal bleeding, or during menstruation.</span>
                </li>
              </ul>
            </CardContent>
          </Card>
